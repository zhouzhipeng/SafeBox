...
/// RFC 8785 canonicalization restricted to the SBOX Catalog value domain.
/// Catalog numbers are schema-limited to JSON safe integers; floating-point
/// values are rejected instead of relying on platform-dependent formatting.
abstract final class CatalogCanonicalJson {
  ...
  static void _writeValue(StringBuffer output, Object? value) {
    switch (value) {
      ...
      case Map<String, Object?>():
        ...
        output.write('}');
      default:
        throw const FormatException('Unsupported Catalog JSON value');
    }
  }
